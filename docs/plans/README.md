...
| [2026-08-14-update-checker.md](2026-08-14-update-checker.md) | 更新检查（Android 跳商店/下载页）与桌面自更新，分两步 | **草案，未动代码**：第一步 v1.2 只告知不安装；第二步 v1.3 才替换可执行文件，前置是签名清单 + 构建期打包类型标记。macOS 已决定跳过（既不构建也不发布，但 README 仍在宣称，需单独修） |
