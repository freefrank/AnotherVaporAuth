...
> **归档说明**：本文是 AVA 的奠基设计文档，当时以"重写老牌工具 Steam Desktop
> Authenticator"为框架起草。AVA 现已是用 Flutter 从零写起的**独立项目**，与 SDA
> 不共享任何代码，仅保持 maFile 格式兼容以便老用户迁移。下文的架构总览仍具参考
> 价值，但许多细节已随后续版本演进——最新架构以代码与 `app/README.md` 为准。
>
> 状态：历史存档 · 日期：2026-06-29
