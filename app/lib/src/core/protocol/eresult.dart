// GENERATED from the canonical Steam EResult enum (values identical to
// SteamKit's EResult.cs / node-steam-user). Maps an EResult code to its name
// for human-readable logging and error messages.
//
// Do not hand-edit individual entries; regenerate from the upstream enum.

/// Steam API result codes (EResult).
const Map<int, String> kEResultNames = {
  0: 'Invalid',
  1: 'OK',
  2: 'Fail',
  3: 'NoConnection',
...
/// Returns a readable label like `AccountLockedDown (73)` for an EResult code,
/// or `EResult <n>` when the code is unknown.
String eresultLabel(int code) {
  final name = kEResultNames[code];
  return name != null ? '$name ($code)' : 'EResult $code';
}
