...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get updateDismiss => 'Omitir';

  @override
  String get settingsUpdateCheck => 'Buscar actualizaciones al iniciar';

  @override
  String get settingsUpdateCheckDesc =>
      'Una vez por inicio, AVA pregunta a su punto de versiones si existe una versión más reciente: una sola petición, sin datos de cuenta, a un punto que no guarda registros. Desactivado, AVA no comprueba nunca; las versiones siguen en ava.dotslash.pro.';
  ...
  String get privacyConsentBody =>
      'AVA guarda tus cuentas de Steam y tus secretos en este dispositivo: nunca se sube nada, salvo que actives la sincronización opcional hacia un servidor que tú elijas, y aun entonces todo se cifra primero en este dispositivo. No hay que crear ninguna cuenta. Las peticiones a Steam van directas a Valve. Dos servicios del desarrollador solo se contactan cuando hacen falta: la comprobación de Pro y los comentarios (solo al pulsar enviar). La versión de Play también muestra anuncios en el plan gratuito. Sin rastreo ni analíticas. Todo está detallado en la política de privacidad; continuar implica aceptarla.';
  ...
  String get privacyUpdateBody =>
      'El aviso de privacidad ha cambiado desde que lo aceptaste. Novedad: AVA ahora puede sincronizar tu biblioteca de cuentas entre tus dispositivos, a través de un servidor que tú elijas — desactivado por defecto, todo se cifra en este dispositivo antes de subirse y el desarrollador no opera ningún servidor de sincronización. Lee el aviso actual más abajo.';
  ...
  String get proErrPurchaseBound =>
      'Esta suscripción está vinculada a otra cuenta de Google. Reinténtalo y elige en el selector la cuenta que usa tu Play Store.';

  @override
  String proErrPurchaseBoundKnown(String account) {
    return 'Esta suscripción está vinculada a $account. Reinténtalo y elige esa cuenta.';
  }
