...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get privacyConsentBody =>
      'AVA conserve toutes vos données sur cet appareil. L\'application n\'a pas de serveur à elle, ne se connecte qu\'aux serveurs Steam de Valve et ne fait ni suivi ni analyse. En continuant, vous acceptez la politique de confidentialité.';
