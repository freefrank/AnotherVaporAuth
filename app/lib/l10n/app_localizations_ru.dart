...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get privacyConsentBody =>
      'AVA хранит все ваши данные на этом устройстве. У приложения нет собственного сервера, оно соединяется только с серверами Steam компании Valve и не ведёт отслеживания или аналитики. Продолжая, вы принимаете политику конфиденциальности.';
